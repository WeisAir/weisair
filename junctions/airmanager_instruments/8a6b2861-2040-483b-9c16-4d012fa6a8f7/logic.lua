...
local announciator_dataref_name = user_prop_add_string("Simulator Source Data Name", "laminar/B738/annunciator/irs_on_dc_left", "The simulator data field to read annunciator status from.")
