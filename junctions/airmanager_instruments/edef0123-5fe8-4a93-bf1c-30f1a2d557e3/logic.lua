...
local announciator_dataref_name = user_prop_add_string("Simulator Source Data Name", "sim/cockpit2/annunciators/pitot_heat", "The simulator data field to read annunciator status from.")
