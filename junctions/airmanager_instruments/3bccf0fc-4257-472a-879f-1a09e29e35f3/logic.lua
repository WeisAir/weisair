...
function callback_inner_knob_turn(direction)
	...
	if direction == 1 then 
		...
		if xpdr_selected_digit == 0 then current_xpdr_code = current_xpdr_code + 1 end
		if xpdr_selected_digit == 1 then current_xpdr_code = current_xpdr_code + 10 end
		if xpdr_selected_digit == 2 then current_xpdr_code = current_xpdr_code + 100 end
		if xpdr_selected_digit == 3 then current_xpdr_code = current_xpdr_code + 1000 end
	...
	xpl_dataref_write("sim/cockpit/radios/transponder_code", "INT", var_cap(current_xpdr_code,0,7777))
end
