...
btn_home = button_add("btn_home.png", "btn_home_pressed.png", 1467, 35, 126, 100, function()
    ...
    timer_home_push_long = timer_start(1500, nil, function()
        fs2020_event("H:GTN650" .. device_id_pms .. "_HomePushLong")
    end)
end,
function()
    ...
    if timer_running(timer_home_push_long) then
        timer_stop(timer_home_push_long)
        fs2020_event("H:GTN650" .. device_id_pms .. "_HomePush")
    end 
end)
btn_direct = button_add("btn_direct.png", "btn_direct_pressed.png", 1467, 243, 126, 100, function()
    ...
    fs2020_event("H:GTN650" .. device_id_pms .. "_DirectToPush")
end)
...
dial_top = dial_add("rotary_black.png", 0, 4, 152, 152, function(direction)
    if direction == 1 then
        ...
        fs2020_event("H:GTN650" .. device_id_pms .. "_VolInc")
    elseif direction == -1 then
        xpl_command("RXP/GTN/VOL_CCW_" .. device_id)
        fsx_event("GPS_BUTTON3", device_id_rxp_fsx)
        fs2020_event("H:GTN650" .. device_id_pms .. "_VolDec")
    end
end)
...
dial_bottom_outer = dial_add("xl_rotary_black.png", 1419, 474, 200, 200, function(direction)
    if direction == 1 then
        ...
        fs2020_event("H:GTN650" .. device_id_pms .. "_KnobLargeInc")
    elseif direction == -1 then
        xpl_command("RXP/GTN/FMS_OUTER_CCW_" .. device_id)
        fsx_event("GPS_GROUP_KNOB_DEC", device_id_rxp_fsx)
        fs2020_event("H:GTN650" .. device_id_pms .. "_KnobLargeDec")
    end
end)
...
dial_bottom_inner = dial_add("inner_rotary_black.png", 1470, 525, 98, 98, function(direction)
    if direction == 1 then
        ...
        fs2020_event("H:GTN650" .. device_id_pms .. "_KnobSmallInc")
    elseif direction == -1 then
        xpl_command("RXP/GTN/FMS_INNER_CCW_" .. device_id)
        fsx_event("GPS_PAGE_KNOB_DEC", device_id_rxp_fsx)
        fs2020_event("H:GTN650" .. device_id_pms .. "_KnobSmallDec")
    end
end)
...
push_top = button_add(nil, "click.png", 56, 60, 40, 40, function()
    ...
    fs2020_event("H:GTN650" .. device_id_pms .. "_VolPush")
end)
push_bottom = button_add(nil, "click.png", 1499, 554, 40, 40, function()
    ...
    timer_bottom_push_long = timer_start(500, nil, function()
        fs2020_event("H:GTN650" .. device_id_pms .. "_KnobPushLong")
    end)
end,
function()
    ...
    if timer_running(timer_bottom_push_long) then
        timer_stop(timer_bottom_push_long)
        fs2020_event("H:GTN650" .. device_id_pms .. "_KnobPush")
    end        
end)