...
local announciator_dataref_name = user_prop_add_string("Simulator Source Data Name", "ixeg/733/bleedair/engine1_start_valve_ann", "The simulator data field to read annunciator status from.")
