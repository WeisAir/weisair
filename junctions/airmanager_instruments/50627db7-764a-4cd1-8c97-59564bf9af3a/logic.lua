...
if user_prop_get(frame_prop) == true then
    ...
    video_stream_id = video_stream_add("xpl/gauges[1]", 6, 7, 400-12+60, 470-15+60, 50, 596, 350, 420)
else
    video_stream_id = video_stream_add("xpl/gauges[1]", 0, 0, 400+60, 470+60, 50, 596, 350, 420)
end