-- ==========================================================================================
--  External EFB 2D Tablet dedicated to Boeing B737-800X/700U/900U ZiboMod for X-Plane 11/12
-- ==========================================================================================
...
-- Values to be updated by Authors
 ...
 local Z_2D_XP_EFB		= "1.5.1"		-- Current EFB release
 local Date_Release		= "20.04.2024"	-- Current release Date
...
--	-----------------	-----------		--------	-----------------------------
--	enjxp_SimPassion	20.04.2023		1.5.1		FIX: Font names case mismatch and removed unused one
--	enjxp_SimPassion	12.07.2023		1.5.0		ADD: New tab on FUEL PAYLOAD page for AIRSIDE SERVICES
...
-- MENU 1 PAGE 1 BUTTONS	--	MAIN MENU 1/2
	...
	-- where with img_m_1_3_2	: m = menu (to identify variable group in this script)
	-- 1 = laminar/B738/tab/menu_page | 3 = laminar/B738/tab/page | 2 = #buttons/8
	-- with img_m_1_1_2_1 and 1_1_2_2 : two different pictures for the same button depending on state
	-- buttons are located as follow		1	2	3	4
	--										5	6	7	8

img_m_1_1_1		= img_add("announc-1.png",c1_btn,l1_btn,x_btn,y_btn) visible(img_m_1_1_1,false)
img_m_1_1_2_1	= img_add("flight_leg_end-1.png",c2_btn,l1_btn,x_btn,y_btn) visible(img_m_1_1_2_1,false)
img_m_1_1_2_2	= img_add("flight_leg_start-1.png",c2_btn,l1_btn,x_btn,y_btn) visible(img_m_1_1_2_2,false)
img_m_1_1_3_1	= img_add("cargo_load_end-1.png",c3_btn,l1_btn,x_btn,y_btn) visible(img_m_1_1_3_1,false)
img_m_1_1_3_2	= img_add("cargo_load_start-1.png",c3_btn,l1_btn,x_btn,y_btn) visible(img_m_1_1_3_2,false)
...
img_m_14_1_6	= img_add("autoflight_handl-1.png",c4_btn,l2_btn,x_btn,y_btn) visible(img_m_14_1_6,false)
...
-- MENU 14 PAGE 1 BUTTONS	--	FUEL, PAYLOAD, CG, OPT PAGE
			...
			if menu_page == 14 then		-- DISPLAY FUEL, PAYLOAD, CG, OPT PAGE
				...
				visible(img_m_14_1_4,true)			visible(img_m_14_1_6,true)
...
function pr_all_off()									-- HIDE ALL OBJECTS AS REQUIRED
	...
	visible(img_m_14_1_5_1,false)		visible(img_m_14_1_5_2,false)		visible(img_m_14_1_6,false)
	visible(img_m_15_1_1,false)			visible(img_m_15_1_2,false)			visible(img_m_15_1_3,false)
	visible(img_m_15_1_4,false)			visible(img_m_15_1_5,false)			visible(img_m_15_1_6,false)
	visible(img_m_15_1_7,false)			visible(img_m_15_1_8,false)
	visible(img_m_16_1_1,false)			visible(img_m_16_1_2,false)			visible(img_m_16_1_3,false)
