...
local SL  = "font:digital-7-mono-italic.ttf; size:48px; color: #cccccc; halign:center;"
local SS  = "font:digital-7-mono-italic.ttf; size:20px; color: #cccccc; halign:center;"
local VL  = "font:arimo_bold.ttf; size:20px; color: #cccccc; halign:center;"
local VS  = "font:arimo_bold.ttf; size:16px; color: #cccccc; halign:center;"
local VSl = "font:arimo_bold.ttf; size:16px; color: #cccccc; halign:left;"
local VSr = "font:arimo_bold.ttf; size:16px; color: #cccccc; halign:right;"
