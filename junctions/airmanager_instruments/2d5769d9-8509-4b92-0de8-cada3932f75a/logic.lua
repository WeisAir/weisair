...
if user_prop_get(frame_prop) == true then
    ...
    video_stream_id = video_stream_add("xpl/gauges[1]", 13, 13, 816, 816, 629, 1220, 629, 629)
else
    video_stream_id = video_stream_add("xpl/gauges[1]", 0, 0, 843, 843, 629, 1220, 629, 629)
end