...
fsx_variable_subscribe("GENERAL ENG OIL TEMPERATURE:2", "Celsius", PT_tmp_FSX)
fsx_variable_subscribe("GENERAL ENG OIL PRESSURE:2", "PSI", PT_press_FSX)
msfs_variable_subscribe("GENERAL ENG OIL TEMPERATURE:2", "Celsius", PT_tmp_FSX)
msfs_variable_subscribe("GENERAL ENG OIL PRESSURE:2", "PSI", PT_press_FSX)