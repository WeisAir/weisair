...
function  press_callback()
    xpl_command( "les/sf34a/acft/aplt/mnp/mcp_nav_src_button_L")
end

function release_callback()
    xpl_command( "les/sf34a/acft/aplt/mnp/mcp_nav_src_button_L",0)
end

btn = button_add(nil,nil,0,0,136,65, press_callback)

-- Simulator data subscription
xpl_dataref_subscribe("LES/saab/annun/MCP/nav_src_L", "FLOAT", ann_value)