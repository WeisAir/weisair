...
fs2020_variable_subscribe("ELECTRICAL MAIN BUS VOLTAGE", "Volts", 
                          ...
                          "AUDIO PANEL VOLUME", "Percent", function(bus_volts, mic_com_1, mic_com_2, audio_com_1, audio_com_2, audio_spkr, audio_mkr, mkr_hi_sens, audio_dme, audio_adf, audio_nav1, audio_nav2, backup_acitve, vol)
