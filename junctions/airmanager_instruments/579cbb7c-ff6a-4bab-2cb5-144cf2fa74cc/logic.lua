...
arduino_button_right = user_prop_add_hardware_id("Panel Right Button ", "ARDUINO_NANO_A_D12", "The right panel button ")
arduino_button_left = user_prop_add_hardware_id("Panel Left Button ", "ARDUINO_NANO_A_D11", "The left panel button")
...
hw_button_add(user_prop_get(arduino_button_right), button_right_pressed)
hw_button_add(user_prop_get(arduino_button_left), button_left_pressed)

-- user properties definitions
-- buttons

local prop_visible_btn_1_1 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_1_1 = user_prop_add_string("Button 1.1 Lable", "INOP", "The button lable shown for button 1 in row 1.")
local prop_command_btn_1_1 = user_prop_add_string("Button 1.1 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_1_2 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_1_2 = user_prop_add_string("Button 1.2 Lable", "INOP", "The button lable shown for button 2 in row 1.")
local prop_command_btn_1_1 = user_prop_add_string("Button 1.2 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_1_3 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_1_3 = user_prop_add_string("Button 1.3 Lable", "INOP", "The button lable shown for button 3 in row 1.")
local prop_command_btn_1_3 = user_prop_add_string("Button 1.3 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_1_4 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_1_4 = user_prop_add_string("Button 1.4 Lable", "INOP", "The button lable shown for button 4 in row 1.")
local prop_command_btn_1_4 = user_prop_add_string("Button 1.4 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_1_5 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_1_5 = user_prop_add_string("Button 1.5 Lable", "INOP", "The button lable shown for button 5 in row 1.")
local prop_command_btn_1_5 = user_prop_add_string("Button 1.5 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_1_6 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_1_6 = user_prop_add_string("Button 1.6 Lable", "INOP", "The button lable shown for button 6 in row 1.")
local prop_command_btn_1_6 = user_prop_add_string("Button 1.6 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_1_7 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_1_7 = user_prop_add_string("Button 1.7 Lable", "INOP", "The button lable shown for button 7 in row 1.")
local prop_command_btn_1_7 = user_prop_add_string("Button 1.7 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_2_1 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_2_1 = user_prop_add_string("Button 2.1 Lable", "INOP", "The button lable shown for button 1 in row 2.")
local prop_command_btn_2_1 = user_prop_add_string("Button 2.1 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_2_2 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_2_2 = user_prop_add_string("Button 2.2 Lable", "INOP", "The button lable shown for button 2 in row 2.")
local prop_command_btn_2_2 = user_prop_add_string("Button 2.2 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_2_3 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_2_3 = user_prop_add_string("Button 2.3 Lable", "INOP", "The button lable shown for button 3 in row 2.")
local prop_command_btn_2_3 = user_prop_add_string("Button 2.3 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_2_4 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_2_4 = user_prop_add_string("Button 2.4 Lable", "INOP", "The button lable shown for button 4 in row 2.")
local prop_command_btn_2_4 = user_prop_add_string("Button 2.4 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_2_5 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_2_5 = user_prop_add_string("Button 2.5 Lable", "INOP", "The button lable shown for button 5 in row 2.")
local prop_command_btn_2_5 = user_prop_add_string("Button 2.5 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_2_6 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_2_6 = user_prop_add_string("Button 2.6 Lable", "INOP", "The button lable shown for button 6 in row 2.")
local prop_command_btn_2_6 = user_prop_add_string("Button 2.6 Command", "sim/none/none", "The command to be fired if this button is pressed.")

local prop_visible_btn_2_7 = user_prop_add_boolean("Button is active", true, "Set to true if the button should be usable.")
local prop_lable_btn_2_7 = user_prop_add_string("Button 2.7 Lable", "INOP", "The button lable shown for button 7 in row 2.")
local prop_command_btn_2_7 = user_prop_add_string("Button 2.7 Command", "sim/none/none", "The command to be fired if this button is pressed.")

-- user properties definitions
-- dials

local prop_visible_dial_1_1 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_1_1 = user_prop_add_string("Dial 1.1 Lable", "INOP", "The dial lable shown for dial 1 in row 1.")
local prop_command_dial_1_1_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_1_1_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_1_1_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_1_1_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_1_1_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_1_2 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_1_2 = user_prop_add_string("Dial 1.2 Lable", "INOP", "The dial lable shown for dial 2 in row 1.")
local prop_command_dial_1_2_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_1_2_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_1_2_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_1_2_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_1_2_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_1_3 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_1_3 = user_prop_add_string("Dial 1.3 Lable", "INOP", "The dial lable shown for dial 3 in row 1.")
local prop_command_dial_1_3_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_1_3_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_1_3_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_1_3_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_1_3_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_1_4 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_1_4 = user_prop_add_string("Dial 1.4 Lable", "INOP", "The dial lable shown for dial 4 in row 1.")
local prop_command_dial_1_4_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_1_4_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_1_4_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_1_4_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_1_4_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_2_1 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_2_1 = user_prop_add_string("Dial 2.1 Lable", "INOP", "The dial lable shown for dial 1 in row 2.")
local prop_command_dial_2_1_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_2_1_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_2_1_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_2_1_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_2_1_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_2_2 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_2_2 = user_prop_add_string("Dial 2.2 Lable", "INOP", "The dial lable shown for dial 2 in row 2.")
local prop_command_dial_2_2_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_2_2_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_2_2_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_2_2_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_2_2_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_2_3 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_2_3 = user_prop_add_string("Dial 2.3 Lable", "INOP", "The dial lable shown for dial 3 in row 2.")
local prop_command_dial_2_3_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_2_3_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_2_3_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_2_3_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_2_3_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_2_4 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_2_4 = user_prop_add_string("Dial 2.4 Lable", "INOP", "The dial lable shown for dial 4 in row 2.")
local prop_command_dial_2_4_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_2_4_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_2_4_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_2_4_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_2_4_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_3_1 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_3_1 = user_prop_add_string("Dial 3.1 Lable", "INOP", "The dial lable shown for dial 1 in row 3.")
local prop_command_dial_3_1_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_3_1_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_3_1_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_3_1_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_3_1_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_3_2 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_3_2 = user_prop_add_string("Dial 3.2 Lable", "INOP", "The dial lable shown for dial 2 in row 3.")
local prop_command_dial_3_2_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_3_2_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_3_2_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_3_2_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_3_2_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_3_3 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_3_3 = user_prop_add_string("Dial 3.3 Lable", "INOP", "The dial lable shown for dial 3 in row 3.")
local prop_command_dial_3_3_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_3_3_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_3_3_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_3_3_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_3_3_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_3_4 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_3_4 = user_prop_add_string("Dial 3.4 Lable", "INOP", "The dial lable shown for dial 4 in row 3.")
local prop_command_dial_3_4_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_3_4_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_3_4_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_3_4_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_3_4_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_4_1 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_4_1 = user_prop_add_string("Dial 4.1 Lable", "INOP", "The dial lable shown for dial 1 in row 4.")
local prop_command_dial_4_1_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_4_1_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_4_1_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_4_1_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_4_1_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_4_2 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_4_2 = user_prop_add_string("Dial 4.2 Lable", "INOP", "The dial lable shown for dial 2 in row 4.")
local prop_command_dial_4_2_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_4_2_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_4_2_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_4_2_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_4_2_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_4_3 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_4_3 = user_prop_add_string("Dial 4.3 Lable", "INOP", "The dial lable shown for dial 3 in row 4.")
local prop_command_dial_4_3_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_4_3_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_4_3_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_4_3_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_4_3_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")

local prop_visible_dial_4_4 = user_prop_add_boolean("Dial is active", true, "Set to true if the dial should be usable.")
local prop_lable_dial_4_4 = user_prop_add_string("Dial 4.4 Lable", "INOP", "The dial lable shown for dial 4 in row 4.")
local prop_command_dial_4_4_outer_clockwise = user_prop_add_string("Command (outer dial clockwise)", "sim/none/none", "The command to be fired if the outer dial is turned clockwise.")
local prop_command_dial_4_4_outer_counterclockwise = user_prop_add_string("Command (outer dial counterclockwise)", "sim/none/none", "The command to be fired if the outer dial is turned counterclockwise.")
local prop_command_dial_4_4_inner_clockwise = user_prop_add_string("Command (inner dial clockwise)", "sim/none/none", "The command to be fired if the inner dial is turned clockwise.")
local prop_command_dial_4_4_inner_counterclockwise = user_prop_add_string("Command (inner dial counterclockwise)", "sim/none/none", "The command to be fired if the inner dial is turned counterclockwise.")
local prop_command_dial_4_4_push_btn = user_prop_add_string("Command for Dial Push Button", "sim/none/none", "Command fired if the dial push button is pressed.")
