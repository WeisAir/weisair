...
local announciator_dataref_name = user_prop_add_string("Simulator Source Data Name", "laminar/B738/annunciator/takeoff_config", "The simulator data field to read annunciator status from.")
