...
local announciator_dataref_name = user_prop_add_string("Simulator Source Data Name", "laminar/B738/annunciator/ap_warn1", "The simulator data field to read annunciator status from.")
...
function press_button()                                    
    xpl_command ( "WeisAIR/b733/mcp/ap_prst_push") 
end
function release_button()                                 
    xpl_command ( "WeisAIR/b733/mcp/ap_prst_release") 
end  
