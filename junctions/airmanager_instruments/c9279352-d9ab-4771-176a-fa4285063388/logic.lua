...
function  press_callback()
    xpl_command( "les/sf34a/acft/wrng/mnp/takeoff_inhibit_button")
end

function release_callback()
    xpl_command( "les/sf34a/acft/wrng/mnp/takeoff_inhibit_button",0)
end

btn = button_add(nil,nil,0,0,136,65, press_callback)

-- Simulator data subscription
xpl_dataref_subscribe("LES/saab/annun/takeoff_inhibit", "FLOAT", ann_value)