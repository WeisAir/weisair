...
fsx_variable_subscribe("ENG FUEL FLOW GPH:1", "Gallons per hour", PT_fuel_flow_FSX)
msfs_variable_subscribe("ENG FUEL FLOW GPH:1", "Gallons per hour", PT_fuel_flow_FSX)